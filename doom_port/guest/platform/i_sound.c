...
/* doomdef.h enables SNDSERV in the official Linux source.  m_misc.c keeps
   sndserver_filename in its defaults table, so the platform replacement must
   preserve the original global even though this backend intentionally emits
   no audio. */
